...
import { DefaultHttpOptions, HttpOptions, OrderServiceAPIClientInterface } from './index';
...
export class OrderServiceAPIClient implements OrderServiceAPIClientInterface {
  ...
  listOrders(
    ...
    const path = `/stores/${args.storeId}/orders`;
  ...
  addToOrder(
    ...
    const path = `/stores/${args.storeId}/orders/${args.orderId}/items/add`;
    const options: APIHttpOptions = {
      ...this.options,
      ...requestHttpOptions,
    };
  ...
  removeFromOrder(
    ...
    const path = `/stores/${args.storeId}/orders/${args.orderId}/items/remove`;
    const options: APIHttpOptions = {
      ...this.options,
      ...requestHttpOptions,
    };
