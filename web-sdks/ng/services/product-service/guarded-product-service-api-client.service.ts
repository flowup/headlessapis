...
import { USE_DOMAIN, USE_HTTP_OPTIONS, ProductServiceAPIClient } from './product-service-api-client.service';
 ...
 */
@Injectable()
export class GuardedProductServiceAPIClient extends ProductServiceAPIClient {
